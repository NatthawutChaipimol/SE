    ...
    <body>
        <div class="box">
            ...
            <span>
                ...
                <input type="radio" name="pStatus" value="0" required><label>อาหาร</label><br>
                <input type="radio" name="pStatus" value="1" required><label>เครื่องดื่ม</label> <br>
                <input type="radio" name="pStatus" value="2" required><label>ขนม</label> <br>
