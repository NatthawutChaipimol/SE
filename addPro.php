        ...
        <div class="box">
            ...
            <span>
                ...
                <label class="LabelText" for="name">ชื่อสินค้า</label>
                    <input type="text" id = "pName" name="name" value="">

                <label class="LabelText" >ราคาสินค้า</label>
                    <input type="text" id = "pPrice" name="price" value="">
                ...
                <label><input type="radio" name="pStatus" value="on">ขาย</label>
                <label><input type="radio" name="pStatus" value="out">ไม่ขาย</label><br>

                <input type="submit" name="submitAdd" value="บันทึก">
                <input type="submit" name="cancleAdd" value="ยกเลิก">
            </span>
