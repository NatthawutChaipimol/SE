...
if($val["bDeliveryStatus"] == "รอการชำระ") $test = "กรุณาชำระเงินก่อนค่ะ";
else if($val["bDeliveryStatus"] == "กำลังเตรียมอาหาร") $text = "กรุณารอสักครู่กำลังเตรียมอาหารให้คุณ";
else if($val["bDeliveryStatus"] == "กำลังจัดส่ง") $text = "กรุณารอสักครู่กำลังไปส่งอาหารให้คุณ";
else if($val["bDeliveryStatus"] == "ส่งสินค้าสำเร็จ") $text = "ขอบคุณที่ใช้บริการ กรุณารีวิวสินค้าเพื่อนำไปปรับปรุงต่อไปค่ะ";
?>
<div class="container">
    <div class="row pt-5">
        <div class="col-7">
            ...
            <div class="border border-success rounded p-3">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td colspan="2">ราตารวม</td>
                            <td><?php echo $order["bTotal"]; ?></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
